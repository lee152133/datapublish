...
public class TimeUtil {
	...
	public static String getSQLTimestamp(Timestamp ts) {
		...
		SimpleDateFormat f = getChSimpleDateFormat("yyyy-MM-dd HH:mm:ss");
...
//		System.out.= println(sdf.format(s.getTime()));
		String source = "2014-03-15 21:04:00"; //1394855675000l     2014-03-15 11:54:35
		SimpleDateFormat format = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss");
//		format.setTimeZone(TimeZone.getTimeZone("Asia/Shanghai"));
		try {
			System.out.println(format.parse(source).getTime());
			
			Calendar c = Calendar.getInstance();
			c.setTimeInMillis(1394888640000l);    //1394888640000l    //2014-03-15 21:04:00 1394931840000l
			System.out.println(formatTime(c, "yyyy-MM-dd HH:mm:ss"));
